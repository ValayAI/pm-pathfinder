...
import { CalculatorIcon, PlusCircleIcon, XCircleIcon, ArrowDownIcon, ArrowUpIcon } from "lucide-react";
  ...
  return (
    <div className="bg-card rounded-lg p-6 shadow-sm border border-border">
      <div className="flex items-center gap-2 mb-4">
        ...
        <h2 className="text-2xl font-semibold">RICE Score Calculator</h2>
      </div>
      
      <p className="text-muted-foreground mb-6">
        Prioritize your feature ideas using the RICE framework (Reach, Impact, Confidence, Effort).
      </p>
          ...
          {aiAnalysis && (
            <Card className="mt-4">
              <CardHeader>
                ...
                <CardDescription>
                  Additional insights based on your RICE scores
                </CardDescription>
              </CardHeader>
              <CardContent>
